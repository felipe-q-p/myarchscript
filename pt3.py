...
os.system('pacman -S archlinux-wallpaper flatpak gnome-terminal falkon kitty baobab evince gparted mpv neofetch htop thunderbird gnome-calculator gthumb libreoffice ecrire')
